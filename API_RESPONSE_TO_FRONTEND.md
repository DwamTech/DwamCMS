...
- **Description:** Use this to authenticate and get the Bearer Token.
- **Request Body (JSON):**
```json
{
...
```
> **Note:** Use the `token` in the `Authorization` header as `Bearer 1|ABCdefGHIjkl...` for all subsequent requests.
